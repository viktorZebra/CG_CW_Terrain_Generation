...
namespace CG
{
    public static class Transformation
    {
        ...
        public static Vector3 Transform(int x, int y, int z, double tetax, double tetay, double tetaz)
        {
            double x_tmp = x;
            double y_tmp = y;
            double z_tmp = z;
            ...
            return new Vector3((int)x_tmp, (int)y_tmp, (int)z_tmp);
        }

        public static Vector3 Transform(Vector3 p, double tetax, double tetay, double tetaz)
        {
            double x_tmp = p.X;
            double y_tmp = p.Y;
            double z_tmp = p.Z;
